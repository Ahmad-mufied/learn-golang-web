...
*	method ini digunakan untuk melakukan parsing data body apakah bisa di parsing menjadi form data atau tidak, jika tidak
*	bisa di parsing, maka akan menyebabkan error
...
func TestFormPost(t *testing.T) {
	requestBody := strings.NewReader("first_name=Ahmad&last_name=Mufied")
