...
*--	Kenapa ini terjadi? Hal ini karena di Go-Lang embed, nama folder ikut menjadi nama resource nya, misal resources/index.js,
*	jadi untuk mengaksesnya kita perlu gunakan URL /static/resources/index.js
